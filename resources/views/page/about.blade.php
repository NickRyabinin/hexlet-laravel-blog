...
@section('content')
    <section>
        ...
        <p>Upd: добавлен асинхронный виджет отображения ip клиента, локации, соответствующей этому ip (ip-api.com) и текущей
            температуры в этой локации (api.open-meteo.com) (применена библиотека arrilot/laravel-widgets, json-файлы от
            внешних API подтягиваются через curl с установленными timeout).</p>
